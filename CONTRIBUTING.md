# Contributing to ngx-i18n-router

We would love for you to contribute to **`ngx-i18n-router`** and help make it even better than it is today! As a contributor,
...
Help us keep **`ngx-i18n-router`** open and inclusive. Please read and follow our [Code of Conduct][coc].
...
You can file new issues by filling out our [new issue form](https://github.com/fulls1z3/ngx-i18n-router/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/fulls1z3/ngx-i18n-router/pulls) for an open or closed PR that relates to your submission.
...
* Push your branch to GitHub:
    ...
    ```
* In GitHub, send a pull request to `ngx-i18n-router:master`.
...
the `ngx-i18n-router` change log**.
...
Samples: (even more [samples](https://github.com/fulls1z3/ngx-i18n-router/commits/master))
```
...
[coc]: https://github.com/fulls1z3/ngx-i18n-router/blob/master/CODE_OF_CONDUCT.md
[github]: https://github.com/fulls1z3/ngx-i18n-router
